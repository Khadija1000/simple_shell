...
/**
 * is_chain - check to see if the current char in
...
/**
 * check_chain - based on the most recent status,
 * determine whether we should chain checks.
 * @info: the parameter
 * @buf: char buffer
 * @p: addres
 * @i: starting position
...
/**
 * replace_vars - function that replaces
