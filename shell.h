...
/**
 * struct passinfo - enables a standard prototype for
 * a function pointer struct by providing
 * pseudo-arguments to send into a function.
 * @arg: a string
 ...
 * @alias: alias node
 * @env_changed: on if environ  changes
